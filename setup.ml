...
(* OASIS_START *)
(* DO NOT EDIT (digest: db069251c5b768822c134e0bb4f6f37e) *)
(*
...
let setup_t =
  {
     ...
     build = OCamlbuildPlugin.build ["-use-menhir -no-hygiene"];
     test = [];
     doc = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Ast"; "Syntax"; "M"; "Alpha"; "Tm"; "Beta"];
                      lib_pack = false;
                      lib_internal_modules = ["Parser"];
     ...
     oasis_digest = Some "\"\236\001\156]tk\214\175\204\129t\135!\151\030";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
